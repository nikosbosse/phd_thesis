...
- Rt forecast stuff. 
  - highly dependent on the model. CFR, no 
...
Adding more metrics to the package. In particular, the ability to pass in custom scoring functions. More metrics for point forecasts. 
