...
- Examine the potential to use public crowd forecasting tournaments to predict COVID-19 in the UK and explore possibilities to combine human judgement and epidemiological modelling (Paper 4)
...
Chapter \@ref(background) provides the background for the following chapters. It gives an overview of and defines important terminology related to forecasting and modelling of infectious diseases. It introduces the concept of forecast evaluation and proper scoring rules (to be deepened in Chapter \ref{sec:scoringutils}) and provides an overview of past human judgement efforts in infectious disease forecasting. 
